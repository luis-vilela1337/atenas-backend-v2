...
export class AddDisplayIdToOrder1757384524428 implements MigrationInterface {
  name = 'AddDisplayIdToOrder1757384524428';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "orders" ADD "display_id" SERIAL NOT NULL`,
    );
    await queryRunner.query(
